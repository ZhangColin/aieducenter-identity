...
class AuthorizeControllerIntegrationTest extends SsoIntegrationTestBase {
    ...
    @Test
    void given_redirect_uri_not_whitelisted_when_authorize_then_400_invalid_request() throws Exception {
    ...
    @Test
    void given_unknown_client_when_authorize_then_400_unauthorized_client() throws Exception {
        mvc.perform(get("/authorize")
