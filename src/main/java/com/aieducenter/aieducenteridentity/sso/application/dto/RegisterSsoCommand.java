...
/**
 * /api/sso/register 注册命令（CONTEXT 注册 / issue #18、#22）。
 *
 ...
 * （设了密码登，没设走 /api/sso/login-code 验证码登）。
 ...
 * @param emailCode   邮箱验证码（先经 /api/sso/verification-code/email 以 REGISTER 用途下发）
 * @param phoneCode   短信验证码（先经 /api/sso/verification-code/sms 以 REGISTER 用途下发）
